...
void Proto_Init(void);//инициализация протокола, интерфейса
void ProtoProcess( void *pvParameters );//процесс обработки протокола
...
unsigned char  CRC_Check( unsigned char  *Spool,unsigned char Count);//расчет CRC
