...
//	  NVIC_Init(&NVIC_InitStructure);
	  ...
	  GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL; //Р’С‹С…РѕРґ Р±РµР· РїРѕРґС‚СЏРіРёРІР°СЋС‰РёС… СЂРµР·РёСЃС‚РѕСЂРѕРІ
...
//							break;
							...
							case CHNL_MEMORY://Р В РЎвЂќР В Р’В°Р В РўвЂ�Р РЋР вЂљ Р РЋРІР‚С™Р В Р’В°Р В Р’В±Р В Р’В»Р В РЎвЂў
							{
...
void ProtoProcess( void *pvParameters )
{
	...
	while(1)
	{
		if( xProtoSemaphore != NULL )
		{
				...
				switch(proto_type)
				{
					...
					case PROTO_TYPE_NEW:
					{
						...
						if(CRC_Check(RecieveBuf,(recieve_count-CRC_LEN))==crc_n)
						{
							...
							ProtoBufHandling();//Р В РЎвЂ”Р РЋР вЂљР В РЎвЂўР РЋРІР‚В Р В Р’ВµР В РўвЂ�Р РЋРЎвЂњР РЋР вЂљР В Р’В° Р В РЎвЂўР В Р’В±Р РЋР вЂљР В Р’В°Р В Р’В±Р В РЎвЂўР РЋРІР‚С™Р В РЎвЂќР В РЎвЂ� Р РЋР С“Р В РЎвЂўР В РЎвЂўР В Р’В±Р РЋРІР‚В°Р В Р’ВµР В Р вЂ¦Р В РЎвЂ�Р РЋР РЏ
							...
							transf_count++;//Р В РЎвЂ�Р В Р вЂ¦Р В РЎвЂќР РЋР вЂљР В Р’ВµР В РЎпїЅР В Р’ВµР В Р вЂ¦Р РЋРІР‚С™Р В РЎвЂ�Р РЋР вЂљР РЋРЎвЂњР В Р’ВµР В РЎпїЅ Р РЋР С“Р РЋРІР‚РЋР В Р’ВµР РЋРІР‚С™Р РЋРІР‚РЋР В РЎвЂ�Р В РЎвЂќ Р В РЎвЂ”Р В Р’ВµР РЋР вЂљР В Р’ВµР В РўвЂ�Р В Р’В°Р В Р вЂ¦Р В Р вЂ¦Р РЋРІР‚в„–Р РЋРІР‚В¦
						}
						else
						{
							crc_n_ERR=0x1;//Р В Р вЂ¦Р В Р’ВµР РЋР С“Р В РЎвЂўР В Р вЂ Р В РЎвЂ”Р В Р’В°Р В РўвЂ�Р В Р’ВµР В Р вЂ¦Р В РЎвЂ�Р В Р’Вµ crc_n
							USART_ITConfig(USART1, USART_IT_RXNE , ENABLE);
			...
			{
				//tablo_proto_parser(&standby_frame);//Р В РЎвЂ”Р В Р’ВµР РЋР вЂљР В Р’ВµР В РўвЂ�Р В Р’В°Р РЋРІР‚РЋР В Р’В° Р В РЎвЂќР В Р’В°Р В РўвЂ�Р РЋР вЂљР В Р’В° standby
			}
		}
	}
}
//-----------------------crc_n------------------------------------------------------------
uint8_t  CRC_Check( uint8_t  *Spool_pr,uint8_t Count_pr )  //Р В РЎвЂ”Р РЋР вЂљР В РЎвЂўР В Р вЂ Р В Р’ВµР РЋР вЂљР В РЎвЂ�Р РЋРІР‚С™Р РЋР Р‰
{
	uint8_t crc_n = 0;
	uint8_t  *Spool;
	uint8_t  Count ;
	...
	Count=Count_pr;
        ...
        {
	        crc_n = crc_n ^ (*Spool++);//
	        // Р РЋРІР‚В Р В РЎвЂ�Р В РЎвЂќР В Р’В»Р В РЎвЂ�Р РЋРІР‚РЋР В Р’ВµР РЋР С“Р В РЎвЂќР В РЎвЂ�Р В РІвЂћвЂ“ Р РЋР С“Р В РўвЂ�Р В Р вЂ Р В РЎвЂ�Р В РЎвЂ“ Р В Р вЂ Р В РЎвЂ”Р РЋР вЂљР В Р’В°Р В Р вЂ Р В РЎвЂў
	        crc_n = ((crc_n & 0x01) ? (uint8_t)0x80: (uint8_t)0x00) | (uint8_t)(crc_n >> 1);
	        // Р В РЎвЂ�Р В Р вЂ¦Р В Р вЂ Р В Р’ВµР РЋР вЂљР РЋР С“Р В РЎвЂ�Р РЋР РЏ Р В Р’В±Р В РЎвЂ�Р РЋРІР‚С™Р В РЎвЂўР В Р вЂ  Р РЋР С“ 2 Р В РЎвЂ”Р В РЎвЂў 5, Р В Р’ВµР РЋР С“Р В Р’В»Р В РЎвЂ� Р В Р’В±Р В РЎвЂ�Р РЋРІР‚С™ 7 Р РЋР вЂљР В Р’В°Р В Р вЂ Р В Р’ВµР В Р вЂ¦ 1
