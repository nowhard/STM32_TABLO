...
//---------------------------------------------------------------------------
	tab.indicators[0].bus=BUS_SPI_2;
	tab.indicators[0].number_in_bus=(IND_SPI_BUS_2_NUM-1)-3;
	...
	tab.indicators[1].number_in_bus=(IND_SPI_BUS_1_NUM-1)-1;
	...
	tab.indicators[2].number_in_bus=(IND_SPI_BUS_2_NUM-1)-2;
	...
	tab.indicators[3].number_in_bus=(IND_SPI_BUS_2_NUM-1)-1;
	...
	tab.indicators[4].number_in_bus=(IND_SPI_BUS_2_NUM-1)-0;
	...
	tab.indicators[5].bus=BUS_SPI_3;
	tab.indicators[5].number_in_bus=(IND_SPI_BUS_3_NUM-1)-1;
	...
	tab.indicators[6].number_in_bus=(IND_SPI_BUS_1_NUM-1)-0;
	...
	tab.indicators[7].number_in_bus=(IND_SPI_BUS_1_NUM-1)-5;
	...
	tab.indicators[8].bus=BUS_SPI_3;
	tab.indicators[8].number_in_bus=(IND_SPI_BUS_3_NUM-1)-2;
	...
	tab.indicators[9].number_in_bus=(IND_SPI_BUS_1_NUM-1)-6;
	...
	tab.indicators[10].bus=BUS_SPI_1;
	tab.indicators[10].number_in_bus=(IND_SPI_BUS_1_NUM-1)-4;
	...
	tab.indicators[11].bus=BUS_SPI_3;
	tab.indicators[11].number_in_bus=(IND_SPI_BUS_3_NUM-1)-4;
	...
	tab.indicators[12].bus=BUS_SPI_3;
	tab.indicators[12].number_in_bus=(IND_SPI_BUS_3_NUM-1)-3;
	...
	tab.indicators[13].number_in_bus=(IND_SPI_BUS_2_NUM-1)-5;
	...
	tab.indicators[14].bus=BUS_SPI_3;
	tab.indicators[14].number_in_bus=(IND_SPI_BUS_3_NUM-1)-0;
	...
	tab.indicators[15].number_in_bus=(IND_SPI_BUS_3_NUM-1)-5;
	...
	tab.indicators[16].number_in_bus=(IND_SPI_BUS_2_NUM-1)-4;
	...
	tab.indicators[17].number_in_bus=(IND_SPI_BUS_2_NUM-1)-6;
	...
	tab.indicators[18].bus=BUS_SPI_1;
	tab.indicators[18].number_in_bus=(IND_SPI_BUS_1_NUM-1)-2;
...
//
	tab.indicators[19].bus=BUS_SPI_1;
	tab.indicators[19].number_in_bus=(IND_SPI_BUS_1_NUM-1)-3;
