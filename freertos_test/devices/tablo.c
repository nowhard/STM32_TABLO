...
//---------------------------------------------------------------------------
	...
	tab.indicators[1].scan_limit=IND_SCAN_LIMIT|(tab.indicators[0].character_num-1);
	...
	tab.indicators[2].number_in_bus=2;
	...
	tab.indicators[2].scan_limit=IND_SCAN_LIMIT|(tab.indicators[0].character_num-1);
	...
	tab.indicators[3].number_in_bus=3;
	...
	tab.indicators[3].scan_limit=IND_SCAN_LIMIT|(tab.indicators[0].character_num-1);
	...
	tab.indicators[4].number_in_bus=4;
	...
	tab.indicators[4].scan_limit=IND_SCAN_LIMIT|(tab.indicators[0].character_num-1);
	...
	tab.indicators[5].bus=BUS_SPI_1;
	tab.indicators[5].number_in_bus=5;
	tab.indicators[5].type=IND_TYPE_SEGMENT;
	tab.indicators[5].character_num=5;
	tab.indicators[5].brightness=IND_BRIGHTNESS|0x9;
	tab.indicators[5].decode_mode=IND_DECODE|IND_DECODE_OFF;
	tab.indicators[5].scan_limit=IND_SCAN_LIMIT|(tab.indicators[0].character_num-1);
	...
	tab.indicators[6].bus=BUS_SPI_1;
	tab.indicators[6].number_in_bus=6;
	tab.indicators[6].type=IND_TYPE_SEGMENT;
	tab.indicators[6].character_num=5;
	tab.indicators[6].brightness=IND_BRIGHTNESS|0x9;
	tab.indicators[6].decode_mode=IND_DECODE|IND_DECODE_OFF;
	tab.indicators[6].scan_limit=IND_SCAN_LIMIT|(tab.indicators[0].character_num-1);
	...
	tab.indicators[7].bus=BUS_SPI_1;
	tab.indicators[7].number_in_bus=7;
	tab.indicators[7].type=IND_TYPE_SEGMENT;
	tab.indicators[7].character_num=5;
	tab.indicators[7].brightness=IND_BRIGHTNESS|0x9;
	tab.indicators[7].decode_mode=IND_DECODE|IND_DECODE_OFF;
	tab.indicators[7].scan_limit=IND_SCAN_LIMIT|(tab.indicators[0].character_num-1);
	...
	tab.indicators[8].number_in_bus=8;
	...
	tab.indicators[8].scan_limit=IND_SCAN_LIMIT|(tab.indicators[0].character_num-1);
	...
	tab.indicators[9].bus=BUS_SPI_1;
	tab.indicators[9].number_in_bus=9;
	...
	tab.indicators[9].scan_limit=IND_SCAN_LIMIT|(tab.indicators[0].character_num-1);
	...
	tab.indicators[10].bus=BUS_SPI_2;
	tab.indicators[10].number_in_bus=0;
	tab.indicators[10].type=IND_TYPE_SEGMENT;
	tab.indicators[10].character_num=5;
	tab.indicators[10].brightness=IND_BRIGHTNESS|0x9;
	tab.indicators[10].decode_mode=IND_DECODE|IND_DECODE_OFF;
	tab.indicators[10].scan_limit=IND_SCAN_LIMIT|(tab.indicators[0].character_num-1);
	...
	tab.indicators[11].number_in_bus=1;
	...
	tab.indicators[11].scan_limit=IND_SCAN_LIMIT|(tab.indicators[0].character_num-1);
	...
	tab.indicators[12].number_in_bus=2;
	...
	tab.indicators[12].scan_limit=IND_SCAN_LIMIT|(tab.indicators[0].character_num-1);
	...
	tab.indicators[13].number_in_bus=3;
	...
	tab.indicators[13].scan_limit=IND_SCAN_LIMIT|(tab.indicators[0].character_num-1);
	...
	tab.indicators[14].number_in_bus=4;
	...
	tab.indicators[14].scan_limit=IND_SCAN_LIMIT|(tab.indicators[0].character_num-1);
	...
	tab.indicators[15].number_in_bus=5;
	tab.indicators[15].type=IND_TYPE_SEGMENT;
	tab.indicators[15].character_num=5;
	tab.indicators[15].brightness=IND_BRIGHTNESS|0x9;
	tab.indicators[15].decode_mode=IND_DECODE|IND_DECODE_OFF;
	tab.indicators[15].scan_limit=IND_SCAN_LIMIT|(tab.indicators[0].character_num-1);
	...
	tab.indicators[16].bus=BUS_SPI_2;
	tab.indicators[16].number_in_bus=6;
	tab.indicators[16].type=IND_TYPE_SEGMENT;
	tab.indicators[16].character_num=5;
	tab.indicators[16].brightness=IND_BRIGHTNESS|0x9;
	tab.indicators[16].decode_mode=IND_DECODE|IND_DECODE_OFF;
	tab.indicators[16].scan_limit=IND_SCAN_LIMIT|(tab.indicators[0].character_num-1);
	...
	tab.indicators[17].bus=BUS_SPI_2;
	tab.indicators[17].number_in_bus=7;
	...
	tab.indicators[17].scan_limit=IND_SCAN_LIMIT|(tab.indicators[0].character_num-1);
	...
	tab.indicators[18].bus=BUS_SPI_2;
	tab.indicators[18].number_in_bus=8;
	tab.indicators[18].type=IND_TYPE_SEGMENT;
	tab.indicators[18].character_num=5;
