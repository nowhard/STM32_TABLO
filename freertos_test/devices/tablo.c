...
//---------------------------------------------------------------------------
	...
	tab.indicators[1].number_in_bus=(IND_SPI_BUS_1_NUM-1)-8;
	...
	tab.indicators[5].number_in_bus=(IND_SPI_BUS_1_NUM-1)-5;
	...
	tab.indicators[6].number_in_bus=(IND_SPI_BUS_1_NUM-1)-6;
	...
	tab.indicators[7].number_in_bus=(IND_SPI_BUS_1_NUM-1)-7;
	...
	tab.indicators[9].number_in_bus=(IND_SPI_BUS_1_NUM-1)-9;
	...
	tab.indicators[10].number_in_bus=(IND_SPI_BUS_2_NUM-1)-5;
	...
	tab.indicators[16].number_in_bus=(IND_SPI_BUS_2_NUM-1)-6;
	...
	tab.indicators[17].number_in_bus=(IND_SPI_BUS_2_NUM-1)-7;
	...
	tab.indicators[18].number_in_bus=(IND_SPI_BUS_2_NUM-1)-8;
	...
	tab.indicators[19].number_in_bus=(IND_SPI_BUS_2_NUM-1)-9;
